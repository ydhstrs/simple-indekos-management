...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="bg-white block w-full overflow-x-auto p-8">
            ...
            <form method="post" action="/dashboard/buying/{{ $item->id }}" enctype="multipart/form-data">
                @csrf
                @method('put')
                <div class="mb-6">
                    ...
                    <input type="text" id="transaction_no" name="transaction_no"
                        ...
                        placeholder="" value="{{ $item->transaction_no }}" required>
                </div>
                <div class="mb-6">
                ...
                <div class="mb-6">
                    ...
                    <input type="text" id="price" name="price"
                        ...
                        placeholder="" value="{{ 'Rp ' . number_format($item->price, 0, ',', '.') }}" required>
                </div>
