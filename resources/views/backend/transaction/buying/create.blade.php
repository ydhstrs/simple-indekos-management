...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="bg-white block w-full overflow-x-auto p-8">
            ...
            <form method="post" action="/dashboard/buying" enctype="multipart/form-data">
                @csrf
                <div class="flex flex-col md:flex-row gap-4 mb-6">
                    <div class="w-full md:w-1/2">
                        ...
                        <input type="text" id="transaction_no" name="transaction_no"
                            value="PAY/{{ date('m/Y') }}/{{ str_pad($counter, 4, '0', STR_PAD_LEFT) }}"
                     ...
                     <div class="flex flex-col md:flex-row gap-4 mb-6">
                    <div class="w-full md:w-1/2">
                        <label for="buying_date" class="block mb-2 text-sm font-medium text-gray-900 ">Tanggal
                            Pembayaran</label>
