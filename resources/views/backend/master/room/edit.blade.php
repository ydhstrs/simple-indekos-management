...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="bg-white block w-full overflow-x-auto p-8">
            ...
            <form method="post" action="/dashboard/room/{{ $item->id }}" enctype="multipart/form-data">
                @csrf
                @method('put')
                <div class="mb-6">
                ...
                <div class="mb-6">
                    ...
                    <input type="text" id="type" name="type"
                        class="form-control bg-gray-50 border border-gray-300 text-black text-sm rounded-lg block w-full p-2.5"
                        placeholder="" value="{{ $item->type }}" required>
                </div>
                <div class="mb-6">
                    ...
                    <input type="text" id="price" name="price"
                        ...
                        placeholder="" value="{{ number_format($item->price, 0, ',', '.') }}" required>
                </div>
                <div class="mb-6">
                    <label for="floor" class="block mb-2 text-sm font-medium text-gray-900 ">Lantai</label>
                    <input type="text" id="floor" name="floor"
                        class="form-control bg-gray-50 border border-gray-300 text-black text-sm rounded-lg block w-full p-2.5"
                        placeholder="" value="{{ $item->floor }}" required>
                </div>
