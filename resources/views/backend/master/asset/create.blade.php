...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="bg-white block w-full overflow-x-auto p-8">
            ...
            <form method="post" action="/dashboard/asset" enctype="multipart/form-data">
                @csrf
                <div class="mb-6">
                ...
                <div class="mb-6">
                    <label for="charge" class="block mb-2 text-sm font-medium text-gray-900 ">Tanggal Beli</label>
